<div class="content-wrapper" style="min-height: 348px;">  
    ...
    <?php
                                     if (!$this->auth->addonchk('ssbr',false)) {
                                                ?>
    <div class="alert alert-danger">
You are using unregistered version of Smart School Behaviour Records addon, please <a href="#" class="displayinline align-text-top" data-addon-version="<?php //echo $version;?>" data-addon="ssbr" data-toggle="modal" data-target="#addonModal">click here</a> to register addon
</div>
                                                <?php
                                            }
                                            ?> 
